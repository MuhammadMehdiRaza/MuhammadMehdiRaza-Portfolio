                ...
                <div className="p-2.5 sm:p-6">
                    ...
                    <div className="flex items-center gap-2 mb-2 sm:hidden">
                        <a
                            ...
                            className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-[10px] font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 rounded-lg transition-all duration-200"
                        >
                        ...
                        {hasVideo && videoSrc && (
                            <button
                                onClick={handleCardClick}
                                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-[10px] font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-all duration-200"
                            >
                                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M8 5v14l11-7z" />
                                </svg>
                    ...
                    {/* Action Buttons - Desktop Only (in image) */}
                    <div className="hidden sm:flex absolute bottom-4 right-4 items-center gap-3 z-30" style={{top: 'auto'}}>
                        <a
                            href={githubLink}
                            target="_blank"
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()}
                            className="w-10 h-10 rounded-full bg-slate-900/90 backdrop-blur-sm flex items-center justify-center text-white hover:bg-slate-800 transition-all duration-200 border border-slate-700 shadow-lg"
                        ...
                        {hasVideo && videoSrc && (
                            <button
                                onClick={handleCardClick}
                                className="w-10 h-10 rounded-full bg-blue-600 hover:bg-blue-700 flex items-center justify-center text-white transition-all duration-200 shadow-2xl"
